  ...
  gulp.task('sass', function (done) {
    ...
    getVersion.then(function (version) {
      ...
      return gulp.src(location['stylessrc'] + '/' + location['csssource'])
        ...
        .pipe(need.gulpif(env === 'production', need.replace('url("royal-canin.sprite--flags.png")', 'url("https://d3moonnr9fkxfg.cloudfront.net/royal-canin.sprite--flags.png?v=' + version + '")')))
